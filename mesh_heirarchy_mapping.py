# adding the genes to its parent:
...
def main():
    ...
    with open("parsed_Mesh_desc.txt") as f:
        for line in f:
    ...
    with open("pre_final_genes_for_disease.txt") as f:
        for line in f:
            parts = line.strip("\n").split(':')
    ...
    # Create a copy of concept_id_to_genes keys to avoid dictionary size change during iteration
